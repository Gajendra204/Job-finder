                    ...
                    {/* Auth Buttons / User Profile */}
                    {
                        !user
                            ...
                            >
                                ...
                                <Link to="/signup">
                                    <Button 
                                        className="bg-gradient-to-r from-[#6A38C2] to-[#5b30a6] hover:from-[#5b30a6] hover:to-[#4a2890] cursor-pointer shadow-lg hover:shadow-xl transition-all duration-300 font-medium px-6"
                                    >
                                        Signup
                                    </Button>
                                </Link>
                                            ...
                                            <Avatar className="cursor-pointer ring-2 ring-gray-200 hover:ring-[#F83002] transition-all duration-300 shadow-md">
                                                {
                                                    user?.profile?.profilePhoto
                                                        ...
                                                        :
                                                        <AvatarImage src="https://cdn.jsdelivr.net/gh/alohe/avatars/png/vibrent_3.png" alt="profile" />
                                                }
                                            </Avatar>
                                        </motion.div>
                                    </PopoverTrigger>
                                            ...
                                            <div className='flex flex-col my-3 text-gray-600'>
                                                {
                                                    ...
                                                    (
                                                        ...
                                                        >
                                                            ...
                                                            <Button className="cursor-pointer text-gray-700 hover:text-[#F83002] font-medium" variant="link">
                                        ...
                                        user && user.role === "recruiter"
                                            ...
                                            <div className='flex flex-col gap-2'>
                                                ...
                                                >
                                                    ...
                                                    <p className='text-lg font-medium text-gray-700'>Companies</p>
                                                </motion.div>
                                                ...
                                                >
                                                    ...
                                                    <p className='text-lg font-medium text-gray-700'>Jobs</p>
                                                </motion.div>
                                            </div>
                                            : (
                                                <div className='flex flex-col gap-2'>
                                                    ...
                                                    >
                                                        ...
                                                        <p className='text-lg font-medium text-gray-700'>Browse</p>
                                                    </motion.div>
                                                </div>
                                            )
                                    }
