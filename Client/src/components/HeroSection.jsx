    ...
    return (
        <div className='relative min-h-screen flex items-center justify-center overflow-hidden'>
            ...
            >
                ...
                >
                    Connect with top companies, explore opportunities that match your skills, 
                ...
                <motion.div
                    ...
                    className='mb-12'
                >
                    <div className={`relative max-w-2xl mx-auto transition-all duration-300 ${isSearchFocused ? 'transform scale-105' : ''}`}>
